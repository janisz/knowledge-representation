...
występujących w $\alpha$. Wtedy dla zdań języka $\mathcal{AL}$  muszą być spełnione następujące warunki:
   ...
   \end{definition}
   \begin{definition}
   Niech $S=(H,O,E,N,T_{\infty})$ będzie strukturą dla scenariusza $Sc=(OBS,ACS)$ zgodną z opisem domeny
...
\begin{itemize}
	...
	\begin{description}
		...
		\item[ever] $\forall_{S=(H,O,E,N,T_{\infty}) \in Mod1(D, Sc)}\; (a_i,t) \in E$
