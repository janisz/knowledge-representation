...
public class Engine {
    ...
    public void UpdateCauses(int t) {
        for (EffectCauses ec : _K._Couses) {
    ...
    public void UpdateInvokes(int t) {
        for (EffectInvokes ei : _K._Invokes) {
    ...
    public void UpdateTriggers(int t) {
        for (EffectTriggers et : _K._Triggers) {
